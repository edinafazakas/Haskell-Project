...
-- WAS Error (UnexpectedInput {gotInput = "def", expectedInput = "string \"abc\" or string \"efg\""})
-- NOW Error (UnexpectedInput {gotInput = "def", expectedInput = "string \"abc\" or string \"efg\""})
